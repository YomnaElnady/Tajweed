...
class Ekhfaa extends Component {
  ...
  await  fetch('https://otrojjah-api.herokuapp.com/api/rule?parentId=5e7b7b1064a37600171db177')
  ...
  //   .then((response)=> console.log(response))
     ...
     await  fetch('https://otrojjah-api.herokuapp.com/api/rule?id=5e7b7b1064a37600171db177')
     .then((response)=> response.json())
  //   .then((response)=> console.log(response))
     .then((response)=>{
       this.setState({
          ...
          <View >
                 ...
                 <View style={{  width: '100%', height: '100%',}}>   
                   <TouchableOpacity onPress={()=>this.setState({showText:!this.state.showText})}>
                     <Text style={{textAlign:'center', backgroundColor:'#c28f48', fontSize:20, margin:10, color:'white',fontFamily: 'a-jannat-lt',borderRadius:30}}>شرح حكم الإخفاء الشفوي</Text>
                   </TouchableOpacity>  
